<?php $domain = "http://localhost/akincom/uploader/"; ?>
<!DOCTYPE HTML>
<html>
<head>
...
<script type="text/javascript" src="<?=$domain?>js/jquery.form.min.js"></script>
...
<img src="<?=$domain?>images/ajax-loader.gif" id="loading-img" style="display:none;" alt="Please Wait"/>
</form>
