<?php
$domain = "http://localhost/akincom/uploader/uploads/";
############ Configuration ##############
...
if(isset($_POST) && isset($_SERVER['HTTP_X_REQUESTED_WITH']) && strtolower($_SERVER['HTTP_X_REQUESTED_WITH']) == 'xmlhttprequest'){
	...
	if($image_res){
		...
		if(normal_resize_image($image_res, $image_save_folder, $image_type, $max_image_size, $image_width, $image_height, $jpeg_quality))
		{
			...
			$a1 = $domain.$thumb_prefix.$new_file_name;
			$a =  '<img src="uploads/'.$thumb_prefix . $new_file_name.'" alt="Thumbnail">';
			echo $a;
			echo "<textarea style='margin: 0px; height: 236px; width: 169px;'>$a1</textarea>";
			echo '<br />';
			$b1 = $domain.$new_file_name;
			$b = '<img src="uploads/'. $new_file_name.'" alt="Resized Image">';
			echo $b;
			echo "<textarea style='margin: 0px; height: 236px; width: 169px;'>$b1</textarea>";
			echo '</div>';
		}
